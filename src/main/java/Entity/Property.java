...
public class Property implements QuadTreeObject, Comparable<QuadTreeObject> {
    private int id;
    private String desc;

    private ArrayList<Parcel> listOfParcels;
    private GPS gps1;
    private GPS gps2;

    public Property(int id, String desc, GPS gps1, GPS gps2){
        this.id = id;
        this.desc = desc;
        this.gps1 = gps1;
        this.gps2 = gps2;
        this.listOfParcels = new ArrayList<>();
    }

    public Property() {}

    public ArrayList<Parcel> getListOfParcels() {
        return this.listOfParcels;
    }
    ...
    public String toString() {
        return "Nehnutelnost " + this.id + " GPS1: " + gps1.getX() + " , " + gps1.getY() + " GPS2: " + gps2.getX() + " , " + gps2.getY();
    }
...
//    }
    ...
    public String toFileString() {
        String line = "Entity.Property;" + this.id + ";" + this.desc + ";"
